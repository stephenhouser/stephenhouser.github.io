...
thumbnail:  /picSimon/picSimon-icon64.png
category:   projects
...
<img alt="Picture of picSimon game" src="{{site.asseturl}}/picSimon/picSimon-1.jpg" style="float: right;" />
...
<p style="text-align: center;"><a href="{{site.asseturl}}/picSimon/picSimon-schematic847x783.png"><img alt="picSimon Schematic" src="{{site.asseturl}}/picSimon/picSimon-schematic489x456.png" />Click image for larger version.</a></p>
...
## Conclusion
<img alt="completed picSimon" style="float: right;" src="{{site.asseturl}}/picSimon/picSimon-3.jpg" /><img alt="completed picSimon" style="float: right;" src="{{site.asseturl}}/picSimon/picSimon-2.jpg" />Overall picSimon was an excellent project for the PIC microcontroller. There are very few components involved, so even the newest people to hardware could build it. Most of the work really goes into the code, which is where I do a much better job at things. Drop me a note and let me know what you think. I had a great time playing with the PIC microcontroller.
